...
This function prints a summary of the results of a `coxtrans` model in a
...
``` r
# S3 method for class 'summary.coxtrans'
print(
  x,
...
- x:
  ...
  A summary object produced from a fitted `coxtrans` model. This object
...
The function prints the summary of the `coxtrans` model and returns the
object `x` invisibly.
